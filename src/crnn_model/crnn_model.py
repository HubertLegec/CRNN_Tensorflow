...
class ShadowNet(CNNBaseModel):
    ...
    def __feature_sequence_extraction(self, inputdata):
        ...
        conv4 = self.conv2d(inputdata=relu3, out_channel=256, kernel_size=3, stride=1, name='conv4')  # batch*8*25*256
        ...
        conv5 = self.conv2d(inputdata=max_pool4, out_channel=512, kernel_size=3, stride=1, name='conv5')  # batch*4*25*512
        ...
        conv6 = self.conv2d(inputdata=bn5, out_channel=512, kernel_size=3, stride=1, name='conv6')  # batch*4*25*512
